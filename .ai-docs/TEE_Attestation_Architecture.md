...
### 6.4 SecretVM release version tracking — DONE (current pin: v0.0.27)
...
| Current SecretVM release pin | https://github.com/scrtlabs/secret-vm-build/releases/tag/v0.0.27 |
