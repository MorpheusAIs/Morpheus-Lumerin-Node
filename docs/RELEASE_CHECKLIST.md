...
- [ ] If a new modality shipped (e.g. Decisions), confirm `docs/consumers/<modality>.mdx`, `docs/reference/models-config.mdx` examples, `docs/reference/api-auth.mdx` permission list, and `docs.json` nav are updated.
