...
- An ERC-20 wallet on BASE with MOR + ETH. If you import a mnemonic, pass the account index of the funded address (`derivationPath`, default `0`); `POST /wallet/derivationPath` switches it later. **Never share your private key.**
