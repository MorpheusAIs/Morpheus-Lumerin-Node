                  ...
                  mode == "mnemonic" ?
                    (
                      <>
                        <AltLayoutNarrow>
                          <Message>
                            Enter a valid 12 word mnemonic to import a previously created
                            wallet and select address
                          </Message>
                        </AltLayoutNarrow>
                        <Sp mt={3}>
                          <TextInput
                    ...
                    (
                      <>
                        <AltLayoutNarrow>
                          <Message>
                            Enter private key to import wallet
                          </Message>
                        </AltLayoutNarrow>
                        <Sp mt={3}>
                          <TextInput
          ...
          mode == "mnemonic" ? (
            <Sp mt={6}>
              <Btn
                ...
                autoFocus
                onClick={e => !isSelectingAddress ? handleSetMnemonic(e) : props.onMnemonicSet(e, derivationIndex)}
                block
              >
