...
const listeners = {
  ...
  'get-rated-bids-by-model': handlers.getRatedBidsByModel,
  'get-session-duration-bounds': handlers.getSessionDurationBounds,
  'estimate-open-session': handlers.estimateOpenSession,
