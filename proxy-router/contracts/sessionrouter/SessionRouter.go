...
// WithdrawableUserStake is a free data retrieval call binding the contract method 0x13796cae.
//
// Solidity: function withdrawableUserStake(address userAddr, uint256 offset, uint8 limit) view returns(uint256 avail, uint256 hold)
func (_SessionRouter *SessionRouterCaller) WithdrawableUserStake(opts *bind.CallOpts, userAddr common.Address, offset *big.Int, limit uint8) (struct {
	Avail *big.Int
	Hold  *big.Int
}, error) {
	var out []interface{}
	err := _SessionRouter.contract.Call(opts, &out, "withdrawableUserStake", userAddr, offset, limit)
...
//
// Solidity: function withdrawableUserStake(address userAddr, uint256 offset, uint8 limit) view returns(uint256 avail, uint256 hold)
func (_SessionRouter *SessionRouterSession) WithdrawableUserStake(userAddr common.Address, offset *big.Int, limit uint8) (struct {
	Avail *big.Int
	Hold  *big.Int
}, error) {
	return _SessionRouter.Contract.WithdrawableUserStake(&_SessionRouter.CallOpts, userAddr, offset, limit)
}

// WithdrawableUserStake is a free data retrieval call binding the contract method 0x13796cae.
//
// Solidity: function withdrawableUserStake(address userAddr, uint256 offset, uint8 limit) view returns(uint256 avail, uint256 hold)
func (_SessionRouter *SessionRouterCallerSession) WithdrawableUserStake(userAddr common.Address, offset *big.Int, limit uint8) (struct {
	Avail *big.Int
	Hold  *big.Int
}, error) {
	return _SessionRouter.Contract.WithdrawableUserStake(&_SessionRouter.CallOpts, userAddr, offset, limit)
