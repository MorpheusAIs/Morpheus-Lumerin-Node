...
export const diamondCutFacetAbi = [
  ...
  {
    type: "error",
    inputs: [{ name: "_selectors", internalType: "bytes4[]", type: "bytes4[]" }],
  ...
  {
    type: "error",
    inputs: [{ name: "_facetAddress", internalType: "address", type: "address" }],
...
export const marketplaceAbi = [
  ...
  {
    type: "function",
    inputs: [{ name: "modelAgentId", internalType: "bytes32", type: "bytes32" }],
...
export const stakingMasterChefAbi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: "undistributedReward", internalType: "uint256", type: "uint256" },
    ],
    stateMutability: "view",
  },
  {
  ...
  },
  {
    type: "function",
    inputs: [{ name: "_poolId", internalType: "uint256", type: "uint256" }],
    name: "withdrawUndistributedReward",
    outputs: [],
    stateMutability: "nonpayable",
  },
] as const;
